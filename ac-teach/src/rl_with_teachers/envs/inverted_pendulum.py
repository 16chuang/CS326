...
from rl_with_teachers.teachers.inverted_pendulum import *
...
class InvertedPendulumEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def make_teachers(self, type, noise=None, drop=0, num_random=0):
        if type == 'default':
            return [PPO2Agent('default')]
        elif type == 'all_other_gravity':
            return [
                PPO2Agent('gravity1'),
                PPO2Agent('gravity5'),
                PPO2Agent('gravity50'),
...
class InvertedPendulumGravity1Env(InvertedPendulumEnv):
    def __init__(self):
        super().__init__(gravity=-1.0)


class InvertedPendulumGravity5Env(InvertedPendulumEnv):
    def __init__(self):
        super().__init__(gravity=-5.0)


class InvertedPendulumGravity20Env(InvertedPendulumEnv):
    def __init__(self):
        super().__init__(gravity=-20.0)


class InvertedPendulumGravity50Env(InvertedPendulumEnv):
    def __init__(self):
...
register(
    ...
    entry_point='rl_with_teachers.envs:InvertedPendulumEnv',
...
register(
    ...
    entry_point='rl_with_teachers.envs:InvertedPendulumGravity1Env',
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    ...
    entry_point='rl_with_teachers.envs:InvertedPendulumGravity5Env',
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    ...
    entry_point='rl_with_teachers.envs:InvertedPendulumGravity20Env',
    max_episode_steps=1000,
    reward_threshold=950.0,
)
...
register(
    ...
    entry_point='rl_with_teachers.envs:InvertedPendulumGravity50Env',
    max_episode_steps=1000,
    reward_threshold=950.0,
)